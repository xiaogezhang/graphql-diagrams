 ...
 * @returns 
 */
export function createQueryPlanGraph(queryPlanStr: string, queryStr?: string): DiagramModel {
...
function processQueryPlan(diagramModel: DiagramModel, node: PlanNode, queryStr?: string): void {
  const nodeModel = new ListNodeModel({
    name: 'Query Plan',
